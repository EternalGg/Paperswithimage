function showdetail() {
	...
	console.log(paper[second[1]].task2)
	document.getElementById("ptitle").innerText = paper[second[1]].name;
	document.getElementById("pdetail").innerText = paper[second[1]].detail;
	document.getElementById("ptime").innerText = paper[second[1]].time + paper[second[1]].anthor;
	document.getElementById("task1").innerText = paper[second[1]].task1;
	document.getElementById("task2").innerText = paper[second[1]].task2;
	document.getElementById("git").href = paper[second[1]].git_hub;
	document.getElementById("p_link").href = paper[second[1]].pdf;
}
var paper = [{
		"-id": "1",
